//Element where I am Mounting the app
...
let myVue = new Vue({
  ...
  data: {
    ...
    // This is an empty watchlist array. You'll find it at the bottom of the page. 
    // All your movies that you click "add" on will be added to the bottom of the page instead of a new page. Kinda makes things easier.
    watchList: [],
  ...
  methods: {
    // I changed the search function a bit so that when the search bar is empty
    // and you click search, it won't search unless you've added a word. Form Validation.
    theSearch() {
    ...
    // This is your Add to watchlist function but for some reason its not working
    // If you can manage to get this working somehow, your project will be done.
  ...
  // this is part of the adding to watchlist function but mostly just adds all the data to local storage
  // The data here is what will be displayed when the add to watchlist function works
  mounted() {
